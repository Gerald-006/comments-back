User.create(image: "https://i.postimg.cc/Qt9Mh5ms/image-amyrobson.png",name: "amyrobson",password: '1234567', email: "amyrobson@gmail.com")
User.create(image: "https://i.postimg.cc/prc5qxsX/image-maxblagun.png",name: "maxblagun",password: 'qwerqwer', email: "maxblagun@gmail.com")
User.create(image: "https://i.postimg.cc/LXT1gjfP/image-ramsesmiron.png",name: "ramsesmiron",password: '987654321', email: "ramsesmiron@gmail.com")
User.create(image: "https://i.postimg.cc/HsQVrwgk/image-juliusomo.png",name: "juliusomo",password: 'juliusomo', email: "juliusomo@gmail.com")
